...
@testset "Lattice triangles by Picard index" begin

    expected_numbers = [1, 1, 1, 1, 1, 2, 1, 2, 2, 2, 1, 2, 1, 2, 2, 2, 1, 3,
                        1, 2, 2, 2, 1, 4, 2, 2, 2, 2, 1, 5, 1, 4, 2, 2, 2, 3,
                        1, 2, 2, 4, 1, 5, 1, 2, 3, 2, 1, 4, 3, 4, 2, 2, 1, 5,
                        2, 4, 2, 2, 1, 5, 1, 2, 3, 3, 2, 5, 1, 2, 2, 5, 1, 6,
                        1, 2, 4, 2, 2, 5, 1, 4, 3, 2, 1, 5, 2, 2, 2, 4, 1, 7,
                        2, 2, 2, 2, 2, 8, 1, 5, 3, 4, 1, 5, 1, 4, 5, 2, 1, 5,
                        1, 5, 2, 4, 1, 5, 2, 2, 3, 2, 2, 10, 3, 2, 2, 2, 3, 7,
                        1, 6, 2, 5, 1, 5, 2, 2, 5, 4, 1, 5, 1, 5, 2, 2, 2, 6,
                        2, 2, 5, 2, 1, 10, 1, 4, 3, 5, 2, 5, 1, 2, 2, 8, 2, 7,
                        1, 2, 5, 2, 1, 10, 4, 5, 3, 2, 1, 5, 4, 4, 2, 2, 1, 7,
                        1, 5, 2, 4, 2, 5, 2, 2, 5, 5, 1, 7, 1, 2, 5, 5, 1, 7,
                        1, 8, 2, 2, 2, 5, 2, 2, 3, 4, 2, 14, 1, 2, 2, 2, 2, 10,
                        2, 2, 2, 5, 2, 5, 1, 8, 6, 2, 1, 5, 1, 5, 5, 4, 1, 7,
                        2, 2, 2, 5, 1, 10, 1, 7, 5, 2, 5, 5, 2, 4, 2, 8, 1, 7,
                        2, 2, 5, 5, 1, 5, 2, 5, 3, 2, 1, 10, 2, 5, 2, 2, 1, 14,
                        1, 4, 5, 2, 4, 5, 1, 2, 3, 10, 1, 5, 1, 2, 5, 5, 2, 12,
                        4, 5, 2, 2, 1, 13, 2, 4, 5, 2, 2, 10, 2, 2, 2, 4, 2, 7,
                        1, 5, 2, 5, 1, 10, 1, 2, 7, 2, 1, 5, 2, 7, 2, 5, 2, 7,
                        4, 2, 2, 4, 2, 14, 1, 2, 3, 2, 2, 10, 1, 8, 2, 5, 2, 7,
                        4, 4, 5, 2, 1, 5, 1, 10, 5, 8, 1, 5, 2, 2, 5, 2, 1, 14,
                        5, 2, 7, 5, 2, 5, 1, 4, 3, 5, 2, 5, 1, 5, 8, 4, 2, 14,
                        1, 5, 2, 2, 1, 14, 5, 2, 3, 2, 1, 14, 2, 10, 2, 2, 2,
                        7, 1, 2, 5, 8, 1, 5, 2, 2, 7, 5, 2, 10, 1, 5, 2, 2, 2,
                        7, 2, 8, 2, 5, 1, 14, 1, 2, 3, 4, 4, 5, 2, 2, 5, 5, 1,
                        10, 1, 5, 5, 2, 2, 5, 1, 10, 8, 5, 1, 5, 2, 2, 2, 7, 1,
                        14, 2, 2, 2, 2, 5, 10, 1, 2, 5, 5, 1, 14, 1, 4, 5, 2,
                        1, 7, 2, 5, 2, 4, 2, 5, 4, 5, 3, 2, 1, 20, 2, 2, 5, 7,
                        2, 14, 1, 4, 2, 13, 1, 5, 2, 5, 7, 4, 2, 5, 1, 8, 2, 2,
                        1, 14, 2, 5, 8, 2, 1, 14, 2, 10, 5, 2, 2, 5, 2, 5, 2,
                        10, 1, 7, 1, 2, 10, 2, 2, 10, 5, 5, 3, 5, 2, 5, 2, 4,
                        2, 2, 5, 14, 1, 2, 2, 8, 2, 14, 1, 2, 3, 10, 2, 10, 2,
                        2, 5, 2, 1, 7, 2, 10, 5, 2, 1, 5, 2, 2, 7, 4, 1, 14, 1,
                        5, 2, 5, 4, 10, 1, 10, 2, 5, 2, 5, 2, 4, 7, 2, 1, 13,
                        2, 5, 2, 4, 1, 14, 5, 2, 2, 5, 1, 20, 1, 5, 3, 2, 7, 5,
                        1, 8, 5, 5, 2, 7, 1, 2, 5, 10, 1, 5, 1, 5, 5, 2, 2, 10,
                        6, 2, 5, 2, 2, 19, 1, 4, 2, 2, 2, 5, 5, 5, 3, 14, 1, 5,
                        1, 5, 5, 5, 1, 14, 2, 10, 5, 2, 1, 5, 2, 4, 3, 5, 1,
                        14, 1, 2, 5, 4, 5, 7, 2, 2, 2, 5, 2, 20, 1, 2, 10, 8,
                        1, 5, 2, 10, 2, 5, 1, 7, 2, 11, 2, 4, 2, 14, 1, 2, 7,
                        2, 2, 10, 2, 2, 2, 10, 1, 14, 2, 7, 5, 2, 2, 5, 1, 5,
                        3, 4, 2, 14, 5, 2, 2, 2, 1, 14, 2, 11, 2, 2, 4, 19, 1,
                        10, 7, 5, 2, 5, 1, 2, 13, 8, 2, 7, 1, 5, 5, 5, 1, 10,
                        2, 2, 3, 5, 2, 23, 1, 4, 2, 5, 2, 14, 1, 2, 5, 10, 1,
                        5, 2, 2, 7, 2, 2, 13, 1, 14, 2, 2, 1, 7, 4, 4, 5, 2, 2,
                        14, 2, 5, 5, 10, 2, 5, 1, 2, 2, 5, 2, 14, 2, 2, 5, 2,
                        1, 14, 2, 16, 3, 2, 2, 5, 5, 5, 2, 4, 1, 19, 1, 5, 2,
                        5, 2, 10, 2, 2, 7, 5, 1, 5, 1, 4, 10, 5, 1, 7, 1, 5, 2,
                        7, 5, 5, 2, 5, 5, 2, 1, 28, 6, 2, 2, 2, 8, 7, 7, 4, 2,
                        10, 2, 5, 1, 5, 7, 4, 1, 14, 1, 5, 5, 2, 1, 20, 2, 2,
                        10, 5, 2, 14, 2, 4, 3, 5, 8, 5, 1, 2, 2, 10, 1, 18, 1,
                        5, 5, 2, 1, 10, 2, 5, 7, 2, 2, 5, 2, 14, 5, 2, 2, 14,
                        2, 5, 5, 4, 2, 5, 1, 2, 3, 14, 1, 10, 2, 2, 5, 2, 2,
                        14, 1, 10, 2, 2, 2, 14, 4, 2, 3, 8, 1, 14, 5, 2, 2, 2,
                        5, 14, 1, 5, 2, 5, 1, 5, 2, 4, 14, 5, 1, 5, 2, 10, 2,
                        10, 1, 7, 2, 2, 5, 2, 2, 19, 7, 5, 3, 2, 2, 14, 1, 14,
                        5, 5, 1, 14, 2, 2, 10, 4, 1, 5, 2, 13, 3, 2, 1, 10, 2,
                        5, 5, 5, 2, 19, 1, 8, 2, 5, 2, 5, 1, 2, 5, 16]

    for p = 1 : 1000
        Ps = classify_lattice_triangles_by_picard_index(p)
        @test length(Ps) == expected_numbers[p]
        @test all(P -> picard_index(P) == p, Ps)
    end

    @test sum(length.(classify_lattice_triangles_by_picard_index.(1:10000))) == 68053

end

@testset "Hausen and Király's classification" begin
    Ks = [1, 2, 3, 4, 5, 6, 8, 9]
    numbers = [[10, 18, 35, 70, 140, 280, 560, 1120, 2240, 4480, 8960],
    ...
    for i = 1 : 8
        Pss = classify_lattice_triangles_integral_degree(Val(Ks[i]), 10)
        @test length.(Pss) == numbers[i]
